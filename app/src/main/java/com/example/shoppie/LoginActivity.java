...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createAccount = findViewById(R.id.CA_txt);
        ...
        createAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent go_to_createAccount = new Intent(LoginActivity.this, CreateAccountActivity.class);
                startActivity(go_to_createAccount);
                finish(); // Optional: Close LoginActivity to prevent going back to it from SplashScreen
            }
        });
    }
